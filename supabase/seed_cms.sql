...
values
  ...
  ('visit', 'hours', 'published', 2, '{"title":"Opening hours","schedule":"Monday – Saturday: 9:00 AM – 2:00 PM","closedNote":"Closed on Sundays and major state holidays.","toursIntro":"To experience the stories fully, we highly recommend taking one of our daily guided tours led by resident docents:","tourSlots":[{"label":"Morning tour","time":"10:00 AM daily"},{"label":"Midday tour","time":"12:00 PM daily"}],"lastEntryNote":"Last entry for self-tour is at 1:00 PM.","walkInNote":"*Walk-ins are accommodated based on availability. To guarantee your spot, please book tickets online in advance."}'::jsonb, now()),
