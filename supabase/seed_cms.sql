...
values
  ...
  ('visit', 'hours', 'published', 2, '{"title":"Opening hours","schedule":"Tuesday – Saturday: 9:00 AM – 2:00 PM","closedNote":"Closed on Sundays, Mondays, and major state holidays.","toursIntro":"To experience the stories fully, we highly recommend taking one of our daily guided tours led by resident docents:","tourSlots":[{"label":"Morning tour","time":"10:00 AM daily"},{"label":"Midday tour","time":"12:00 PM daily"}],"lastEntryNote":"Last entry for self-tour is at 1:00 PM.","walkInNote":"*Walk-ins are accommodated based on availability. To guarantee your spot, please book tickets online in advance."}'::jsonb, now()),
  ...
  ('visit', 'safety', 'published', 4, '{"intro":"We thought about you. You are welcome here.","terrainTitle":"Terrain and navigation","terrainDesc":"The Village path is a dirt/gravel trail approximately 0.5 miles long. Comfortable walking shoes are highly recommended. Restrooms are fully ADA-compliant and located in the main visitor courtyard. Service animals are welcome throughout the Village.","guidelinesTitle":"Preserving cultural heritage","guidelinesDesc":"Please do not climb on historical structures or touch displays marked with preservation tags. Hawaii''s Plantation Village is a smoke-free facility."}'::jsonb, now()),
  ...
  ('learn', 'school', 'published', 1, '{"stamp":"For educators & students","stampClass":"green","title":"History feels different when you can experience it","subtitle":"Bring learning beyond the classroom. At Hawaiʻi''s Plantation Village, students enter historic homes, explore cultural gardens, encounter everyday objects and hear stories that connect Hawaiʻi''s plantation era to the islands they know today.","resourcesIntro":"Start our HIDOE standard-aligned interactive lessons. Each package includes videos, guided reading, quizzes, and hands-on activities:","fieldTripNote":"Field trips require a minimum of 10 students and at least one adult chaperone per 10 children."}'::jsonb, now()),
  ...
  ('support', 'header', 'published', 1, '{"stamp":"Help us keep our stories alive","stampClass":"green","title":"What we preserve today becomes tomorrow''s legacy.","subtitle":"Hawaiʻi''s Plantation Village exists because generations of people knew these stories mattered. You can help us carry this important work forward."}'::jsonb, now()),
