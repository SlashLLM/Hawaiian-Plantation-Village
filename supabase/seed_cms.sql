...
values
  ...
  ('learn', 'school', 'published', 1, '{"stamp":"For educators & students","stampClass":"green","title":"History feels different when you can experience it","subtitle":"Bring learning beyond the classroom. At Hawaii''s Plantation Village, students enter historic homes, explore cultural gardens, encounter everyday objects and hear stories that connect Hawaiʻi''s plantation era to the islands they know today.","resourcesIntro":"Start our HIDOE standard-aligned interactive lessons. Each package includes videos, guided reading, quizzes, and hands-on activities:","fieldTripNote":"Field trips require a minimum of 10 students and at least one adult chaperone per 10 children."}'::jsonb, now()),
